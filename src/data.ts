...
export const experience = [
  {
    ...
    current: true,
    bullets: [
      "Technical lead and forward-deployed engineer owning engineering end-to-end with a 2-engineer team. Shipped multiple production AI platforms 0-to-1 in 2 to 3 weeks with full client sign-off.",
      "CortexON: Contributed to TheAgentic's open-source generalized AI agent for everyday task automation. 455 GitHub stars.",
      ...
      "Ad-tech platform: Improved AI image and video generation quality and delivery workflows for a production creative-generation platform.",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Owned engineering end-to-end: hiring, interviews, sprint planning, knowledge transfers, and direct coordination with US school administrators.",
      "Integrated Stripe billing with role-based access and deployed CI/CD across Vercel and Netlify via GitHub Actions.",
  ...
  },
  {
    ...
    current: false,
    bullets: [
      "Returned to CodeSpaze to lead AI & Engineering, after starting here as a Software Engineer in 2021.",
      "Led 20-member cross-functional team (engineers, designers, content, marketing). Drove 10x growth to 10K+ applicants in 2 months and scaled the company's AI services practice.",
  ...
  },
  {
    ...
    current: false,
    bullets: [
      "Led 60+ AI engineers across 15+ countries as Data Engineering Lead on a fixed-scope Omdena project. Built YOLOv8 + PyTorch pipelines on 100K+ annotated images for healthcare diagnostics (autism early detection) and infrastructure monitoring (pavement degradation).",
      "Delivered the system to the Nigerian government on project completion. Coordinated across 15 time zones via GitHub and Slack, managing ML pipelines and research documentation.",
    ],
  ...
  },
  {
    ...
    current: false,
    bullets: [
      "Shipped 8+ client applications across web, AI, and automation engagements, owning frontend and backend features end-to-end on 2 to 3 week delivery cycles.",
      "Built reusable component libraries and internal tooling that cut project setup and delivery time by ~30%, and contributed to the early AI/ML prototypes that seeded the company's AI service line.",
    ],
